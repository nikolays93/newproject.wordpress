...
if ( ! function_exists( 'bootstrap_navbar' ) ) {
	function bootstrap_navbar( $args = array(), $before = '<div class="container">', $after = '</div>' ) {
		...
		if ( $args['togglerClass'] ) :
			...
			?>
			<button type="button"
					class="navbar-toggler <?php echo $args['togglerClass']; ?>"
					data-toggle="collapse"
					data-target="#<?php echo $args['container_id']; ?>"
					aria-controls="<?php echo $args['container_id']; ?>"
					aria-expanded="false"
