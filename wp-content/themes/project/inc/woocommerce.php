...
if( !function_exists('add_custom_theme_woocommerce_support') ) {
 ...
 */
add_filter( 'woocommerce_enqueue_styles', 'wc_theme_dequeue_styles' );
if( !function_exists('wc_theme_dequeue_styles') ) {
